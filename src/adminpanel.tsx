...
function Adminpanel() {
  ...
  const [radioStateErstwunschSchule, setRadioStateErstwunschSchule] = useState('');
  ...
  const handleRadioErstwunschSchule = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleGeschwisterHtl = (event: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        <Tabs
          ...
          <Tab eventKey="Bewerber" title="Bewerber" >
            <Col className="justify-content-center">
              ...
              <Form.Label ><Badge bg="primary">Ausbildung</Badge></Form.Label>
              <Row className="pb-4">
                ...
                <Form.Group as={Col} controlId="validationBewerberAnmeldungstyp" >
                  <FloatingLabel
                ...
                <Form.Group as={Col} controlId="validationBewerberSchuelerkennzahl" >
                  <FloatingLabel
                    controlId="formBewerberSchuljahr"
              ...
              <Row><Form.Group as={Col} controlId="validationBewerberAnmeldenummer" >
                <FloatingLabel
                  controlId="formBewerberSchuljahr"
                  label="Anmeldenummer"
                  className="pt-1"
              ...
              <Row className="pt-3"><Form.Group as={Col} controlId="validationEignungstestdatum">
                <FloatingLabel
              ...
              <Form.Label ><Badge bg="primary">Noten</Badge></Form.Label>
...
nation note
              ...
              <Form.Label ><Badge bg="primary">Persönliche Daten</Badge></Form.Label>
              <Row className="mb-4 mt-4 ">
              ...
              <Row className="mb-4">
                <Form.Group controlId="validationMuttersprache">
                  ...
                  >
                    <Form.Select required>
                      <option value="47">Afrikaans</option><option value="1">Albanisch</option><option value="55">Amerikanische Sprachen</option><option value="52">Amharisch</option><option value="2">Arabisch</option><option value="3">Aramäisch</option><option value="4">Armenisch</option><option value="5">Bengalisch</option><option value="6">BKS (Bosnisch/Kroatisch/Serbisch)</option><option value="7">Bosnisch</option><option value="8">Bulgarisch</option><option value="9">Chinesisch (ohne nähere Differenzierung)</option><option value="10">Dari</option><option value="11">Deutsch</option><option value="12">Englisch</option><option value="13">Estnisch</option><option value="14">Finnisch</option><option value="15">Französisch</option><option value="49">Georgisch</option><option value="54">Griechisch</option><option value="16">Hindi</option><option value="17">Indonesisch</option><option value="18">Italienisch</option><option value="19">Koreanisch</option><option value="20">Kroatisch</option><option value="21">Kurdisch</option><option value="56">Litauisch</option><option value="22">Makedonisch</option><option value="51">Mongolisch</option><option value="23">Niederländisch/Flämisch</option><option value="24">Österreichische Gebärdensprache</option><option value="25">Pashto</option><option value="26">Persisch (Farsi)</option><option value="27">Polnisch</option><option value="48">Portugisisch</option><option value="28">Punjabi</option><option value="29">Rumänisch</option><option value="30">Russisch</option><option value="50">Schwedisch</option><option value="31">Serbisch</option><option value="32">Serbokroatisch</option><option value="33">Slowakisch</option><option value="34">Slowenisch</option><option value="35">Sonstige afrikanische Sprachen</option><option value="36">Sonstige Sprache(n)</option><option value="37">Spanisch</option><option value="38">Tagalog</option><option value="53">Thailändisch</option><option value="39">Tschechisch</option><option value="40">Tschetschenisch</option><option value="41">Türkisch</option><option value="42">Ukrainisch</option><option value="43">Ungarisch</option><option value="44">Urdu</option><option value="45">Vietnamesisch</option><option value="46">Yoruba</option>
              ...
              <Row className="mb-4">
                <Form.Group controlId="validationReligion">
                  <FloatingLabel
                    ...
                    className="pt-1"
                  > <Form.Select required>
                      <option value="47">Alt-Alevitische Glaubensgemeinschaft in Österreich</option><option value="1">altkatholisch</option><option value="2">armenisch-apostolisch</option><option value="3">armenisch-katholisch</option><option value="4">äthiopisch-katholisch</option><option value="48">Bahai-Religionsgemeinschaft Österreich</option><option value="5">buddhistisch</option><option value="6">bulgarisch-katholisch</option><option value="7">bulgarisch-orthodox</option><option value="8">Bund der Baptistengemeinden in Österreich</option><option value="9">Bund evangelikaler Gemeinden in Österreich</option><option value="10">byzantinisch-katholisch</option><option value="11">chaldäisch-katholisch</option><option value="49">Die Christengemeinschaft in Österreich</option><option value="12">Elaia Christengemeinschaft</option><option value="13">evangelisch A.B.</option><option value="14">evangelisch H.B.</option><option value="15">evangelisch-methodistisch</option><option value="16">Freie Christengemeinde/Pfingstgemeinde Österreich</option><option value="57">Freikirchen in Österreich</option><option value="17">freikirchlich</option><option value="18">griechisch-katholisch</option><option value="19">griechisch-orthodox</option><option value="50">Hinduistische Religionsgesellschaft in Österreich</option><option value="20">islamisch</option><option value="21">Islamische Alevitische Glaubensgemeinschaft in Österreich</option><option value="51">Islamische-Schiitische Glaubensgemeinschaft in Österreich</option><option value="22">israelitisch</option><option value="23">italo-albanisch</option><option value="24">Jehovas Zeugen</option><option value="52">Kirche der Siebenten-Tags-Adventisten</option><option value="25">Kirche Jesu Christi der Heiligen der Letzten Tage</option><option value="26">koptisch-katholisch</option><option value="27">koptisch-orthodox</option><option value="28">maronitisch-katholisch</option><option value="29">melkitisch-katholisch</option><option value="30">Mennonitische Freikirche Österreich</option><option value="31">neuapostolisch</option><option value="45">ohne Bekenntnis</option><option value="56">orthodox</option><option value="58">Österreichische Sikh Glaubensgemeinschaft</option><option value="53">Pfingstkirche Gemeinde Gottes in Österreich</option><option value="32">römisch-katholisch</option><option value="33">rumänisch-katholisch</option><option value="34">rumänisch-orthodox</option><option value="35">russisch-orthodox</option><option value="36">ruthenisch-katholisch</option><option value="37">serbisch-orthodox</option><option value="38">slowakisch-katholisch</option><option value="55">Sonstige</option><option value="39">syrisch-katholisch</option><option value="40">syrisch-orthodox</option><option value="41">syro-malabar-katholisch</option><option value="42">syro-malankar-katholisch</option><option value="43">ukrainisch-katholisch</option><option value="44">ungarisch-katholisch</option><option value="54">Vereinigungskirche in Österreich</option>
                    </Form.Select>
                  </FloatingLabel>
                </Form.Group>
              ...
              <Row className="mb-3 mt-4 ">
                <Form.Group controlId="validationGeschwister">
                  ...
                  >
                    ...
                    />
                    <Form.Control.Feedback type="invalid" className="mx-2">
                      Bitte geben Sie die Namen ihrer Geschwister an der HTBLuVA Salzburg an.

                    </Form.Control.Feedback>
                  </FloatingLabel>
                </Form.Group>
              </Row>
              <Form.Label><Badge bg="primary">Bewerberprotokoll</Badge></Form.Label>
              ...
              <Row >
                ...
                <Form.Group as={Col} controlId="validationBewerberprotokollZeitpunkt" >
                  <FloatingLabel
                    // controlId="formVorname"
                    label="Zeitpunkt"
                    className="pt-1"
                ...
                <Form.Group controlId="validationBewerberprotokollBewerber" as={Col}>
                  <FloatingLabel
                    // controlId="formNachname"
                    label="Bewerber"
                    className="pt-1 "
              ...
              <Row >
                <Form.Label ><Badge bg="primary">Fachrichtungen</Badge></Form.Label>
                <Form.Group as={Col}
              ...
              <Row className="mb-4">
                ...
                <Form.Group as={Col} className="pt-4" controlId="validationErstwunschschule">
                  <FloatingLabel
                    controlId="formErstwunschschule"
                    label="Erstwunschschule"
                ...
                <Form.Group as={Col} className="pt-4" controlId="validationErstwunschschulkennzahl">
                  <FloatingLabel
              ...
              <Row className="pb-4">
                ...
                <Form.Group as={Col} controlId="validationZweitwunschSchulkennzahl">
                  <FloatingLabel
              ...
              <Form.Label ><Badge bg="primary">Erziehungsberechtigte</Badge></Form.Label>
              <Form.Group className="mb-3" id="formGridErsterErziehungsberechtigter">
                <Accordion>
                  <Accordion.Item eventKey="0">
                    <Accordion.Header className='text-break'>1. Erziehungsberechtigter</Accordion.Header>
                        ...
                        <Form.Group controlId="validationErsterErziehungsberechtigter">
                          ...
                          >
                            <Form.Select required>
                              ...
                              <option value="3">Vater</option><option value="4">Mutter</option><option value="5">Großvater</option><option value="6">Großmutter</option><option value="7">Onkel</option><option value="8">Tante</option><option value="9">Bruder</option><option value="10">Schwester</option><option value="11">Stiefvater</option><option value="12">Stiefmutter</option><option value="13">Erziehungsberechtigter</option><option value="14">Vormund</option><option value="15">Pflegeeltern</option><option value="16">Heim / WG</option><option value="17">Eltern</option><option value="18">Erziehungsberechtigt</option><option value="19">Ansprechperson</option>
                            </Form.Select>
                      ...
                      <Row className="mb-4 mt-4 ">
                        <Form.Group controlId="validationVorname">
                          ...
                          >
                            ...
                            />
                            <Form.Control.Feedback type="invalid" className="mx-2 ">
                              Bitte geben Sie den Vornamen des Erziehungsberechtigten an.
                            </Form.Control.Feedback>
                          </FloatingLabel>
                        </Form.Group>
                      </Row>
                        ...
                        >
                          ...
                          >
                            ...
                            <Container className="mt-2">
                              <Form.Text id="telHelpBlock" muted>
                                Über diese Tel. Nr. müssen Sie im Verlauf des
                                Aufnahmeprozesses erreichbar sein sowie bei Anfragen von Lehr- sowie Administrativen-Personen.
                                {
                                  /* Die E-Mail
                                Adresse muss von einem Erziehungsberechtigten abgerufen
                                werden. */
              ...
              <Form.Group className="mb-3" id="formGridZweiterErziehungsberechtigter">
                <Accordion>
                  <Accordion.Item eventKey="0">
                    <Accordion.Header className='text-break'>2. Erziehungsberechtigter</Accordion.Header>
                    <Accordion.Body className="text-wrap">
                      <Row className="mb-4">
                        <Form.Group controlId="validationErsterErziehungsberechtigter">
                          <FloatingLabel
          ...
          <Tab eventKey="Organisation" title="Organisation">
            ...
            <Form.Label className="pt-3 h5" ><Badge bg="primary">Abteilungen</Badge></Form.Label>
            <Row >
              <Form.Group as={Col} controlId="validationAbteilungenKuerzel" >
                <FloatingLabel
                  // controlId="formVorname"
                  label="Abteilungskürzel"
                  className="pt-1"
                >
                  <Form.Control
                    required
              ...
              <Form.Group controlId="validationAbteilungenName" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
            ...
            <Row><Form.Group controlId="validationAbteilungenX" as={Col}>
              <FloatingLabel
                // controlId="formNachname"
                label="X"
                className="pt-1 mt-1"
              ...
              <Form.Group controlId="validationAbteilungenY" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
                  label="Y"
                  className="pt-1 mt-1"
            ...
            <Form.Label className="pt-4 h5" ><Badge bg="primary">Benutzer</Badge></Form.Label>
            <Row >
              ...
              <Form.Group as={Col} controlId="validationBenutzerMailadresse" >
                <FloatingLabel
                  // controlId="formVorname"
                  label="Mailadresse"
                  className="pt-1"
              ...
              <Form.Group controlId="validationBenutzerNachname" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
                  label="Nachname"
                  className="pt-1 "
            ...
            <Row><Form.Group controlId="validationBenutzerVorname" as={Col}>
              <FloatingLabel
                // controlId="formNachname"
                label="Vorname"
                className="pt-1 mt-1"
              ...
              <Form.Group controlId="validationBenutzerPerson" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
                  label="Person"
                  className="pt-1 mt-1"
          ...
          Bitte geben Sie den Nachnamen des Bewerbers an.
            ...
            <Row >
              <Form.Group as={Col} controlId="validationOrtschaftenOrtschaft" >
                <FloatingLabel
                  // controlId="formVorname"
                  label="Ortschaft"
                  className="pt-1"
          ...
          Bitte geben Sie den Vornamen des Bewerbers an.
              ...
              <Form.Group controlId="validationOrtschaftenOrtschaftskennzahl" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
                  label="Ortschaftskennzahl"
                  className="pt-1"
                >
                  <Form.Control
                    required
          ...
          Bitte geben Sie den Nachnamen des Bewerbers an.
              ...
              <Form.Group controlId="validationOrtschaftenPostleitzahlen" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
          ...
          Bitte geben Sie den Nachnamen des Bewerbers an.
            ...
            <Row><Form.Group controlId="validationReligionsbekenntnisseAbmeldbar" as={Col}>
              <Form.Check
                type="checkbox"
                // controlId="formNachname"
                label="Abmeldbar"
            ...
            <Row >
              <Form.Group as={Col} controlId="validationReligionsbekenntnisseUnterrichtsnummer" >
                <FloatingLabel
                  // controlId="formVorname"
          ...
          Bitte geben Sie den Vornamen des Bewerbers an.
              ...
              <Form.Group controlId="validationReligionsbekenntnisseKuerzel" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
                  label="Kürzel"
                  className="pt-1"
          ...
          Bitte geben Sie den Nachnamen des Bewerbers an.
              ...
              <Form.Group controlId="validationReligionsbekenntnisseZaehlenAls" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
                  label="Zählen als"
                  className="pt-1"
          ...
          Bitte geben Sie den Nachnamen des Bewerbers an.
            ...
            <Row>
              <Form.Group controlId="validationReligionsbekenntnisseUnterrichtsnummer" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
                  label="Unterrichtsnummer"
                  className="pt-1 mt-1"
          ...
          Bitte geben Sie den Nachnamen des Bewerbers an.
              ...
              <Form.Group controlId="validationReligionsbekenntnisseUnterrichtsbezeichnung" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
              ...
              <Form.Group controlId="validationReligionsbekenntnisseAliasEinschreiber" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
              ...
              <Form.Group controlId="validationReligionsbekenntnisseAliasSK" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
                  label="Alias SK"
                  className="pt-1 mt-1"
            ...
            <Row>
              <Form.Group controlId="validationReligionsbekenntnisseAliasHtl" as={Col}>
                <FloatingLabel
                  // controlId="formNachname"
                  label="Alias Htl"
                  className="pt-1 mt-1"
